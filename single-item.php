            ...
            <div class="col-md-4">
              ...
              <input type="hidden" name="PROID" value="<?php  echo $result->PROID; ?>">
                ...
                <ul>
                    ...
                    <li>Harga setelah diskon - Rp <?php echo $result->PRODISPRICE; ?> </li> 
                    <?php } ?>
                    <li>Jumlah yang Tersedia - <?php echo $result->PROQTY; ?></li>
                </ul>

                 <button  type="submit"  class="btn btn-pup btn-sm"  name="btnorder">Pesan Sekarang!</button>
            </div>
<?php } ?>       
        </div>
        <!-- /.row -->
...
?>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h3 class="page-header">Produk-produk terkait</h3>
            </div>
<?php
