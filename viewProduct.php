                    ...
                    <ul>
                      ...
                      <li>Harga - Rp <?php echo $cur->PROPRICE; ?></li>
                       <?php if($cur->PRODISCOUNT>0){ ?>
                        ...
                        <li>Harga setelah diskon - Rp <?php echo $cur->PRODISPRICE; ?> </li> 
                        <?php } ?>
                      <li>Jumlah yang Tersedia - <?php echo $cur->PROQTY; ?></li>
                    </ul> 
                    <button class="btn btn-pup"  name="btnorder" type="Submit">OPesan Sekarang!</button> 
