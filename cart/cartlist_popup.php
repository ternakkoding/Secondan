    ...
    <div class="col-md-12 col-sm-8 content">  
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default panel-shadow">
                    ...
                    <div class="table-responsive">
                         ...
                         <thead>
                           <tr>
                             <td>
                             <div class="culomn4"><div style="float: left; width:90px">produk</div></div>
                             <div class="culomn4"><div style="float: left; width:250px">Deskripsi</div></div>
                             <div class="culomn4"><div style="float: left; width:200px">Jumlah Stok</div></div>
                             <div class="culomn4"><div style="float: left; width:110px">Harga</div></div>
                         ...
                         <body onload=" totalprice(); ">
                              ...
                              <form id="form" action="cart/controller.php?action=edit" method="POST"  
                                  ...
                                  <div class="column4">                                  
                                    ...
                                    <div class="form-inline" style="float: left; width:190px">  
                                        ...
                                        <button type="submit" name="update" class="btn btn-link" >Perbarui</button>                                     
                                     </div> 
                            ...
                            <tr >  
                            <td>                               
                             <div class="culomn4"><div style="float: right;"><h1> Total Harga : Rp<span id="sum">0</span></h1></div></div>
                            </td>                        
                ...
                <a href="index.php?page=7" name="proceed"  class="btn btn_fixnmix pull-right"   ><strong>Lanjutkan Dan Checkout</strong> <span class="glyphicon glyphicon-chevron-right"></span></a> 
