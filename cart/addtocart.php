      ...
      <div class="">
        <div class="panel panel-default">
          <div class="panel-body">  
            <fieldset>  
              <legend><h2 class="text-left">Daftar Keranjang</h2></legend>
          <div>Setiap produk memiliki garansi sampai penerima mendapatkan barang sesuai keinginan.</div>
      <div class="table-responsive">
       <div  class="fixnmix_scroll_carttwo" >
        ...
        ?>
                  ...
                  <table  >
                  <tfoot >
                     <strong><h1 align="right">Total Harga : Rp <span style="margin-right:3%"  id="sum">0.00</span></h1></strong></td>
            ...
            <div class="modal-dialog"  style="width:50%">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel">Sudah Memiliki Akun?</h4>
                </div>
                ...
                <ul class="nav nav-tabs" id="myTab">
                  ...
                  <li><a href="#settings" data-toggle="tab">Daftar</a></li>
                </ul>
                    <!-- <h2>Login</h2> -->
                    <div class="tab-content"> 
                      ...
                      <form action="login.php"  onsubmit="return validatepasswords()"  method="post">
                          <div class="modal-body">
                              ...
                              <p align="left">&copy; Perbaiki dan Campur Sistem Pemesanan</p>
                              <button class="btn btn-default"   data-dismiss="modal" type=
                              "button">Tutup</button>  
                              <button class="btn btn_fixnmix"
                              name="MbtnLogin" type="submit">Masuk</button>
                            </div>
              ...
              $res = $autonum->single_autonumber(1);
               ...
               ?> 
                ...
                <div class="panel panel-default">
                <div class="panel-head" style="margin-left:3%"><h3>alamat </h3></div>
                    <div class="panel-body">
                      <div class="form-group">
                        <div class="col-md-10">
                          <label class="col-md-4 control-label" for=
                          "HOMENUMBER">Nomor Rumah:</label>
                 ...
                 <!--  <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-10">
                      ...
                      <div class="col-md-8">
                      <p>Catatan!</p>
                      Kata sandi harus terdiri dari minimal 8 sampai 15 karakter. Hanya huruf, angka numerik, garis bawah, dan karakter pertama yang harus berupa huruf.
                      </div> 
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-10">
                      <label class="col-md-4 control-label" for=
                      "CONTACTNUMBER">Nomor Kontak:</label>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <!-- <input type="checkbox" name="condition" value="checkbox" /> -->
                      <small>Setuju <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>Syarat Dan Ketentuan</b></a> tentang SECONDAN</small>
                      
                      </div>
                    </div>
                  </div>
 
                  <div class="modal-footer"><p align="left">&copy; Perbaiki dan Campur Sistem Pemesanan</p>
                    <button class="btn btn-default" data-dismiss="modal" type=
                    "button">Tutup</button> 
                    <button type="submit"  name="savecustomer"   class="submit btn btn_fixnmix" >Daftar</button> 
                    <!-- <button class="btn btn_fixnmix"
