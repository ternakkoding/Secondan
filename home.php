          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>SECONDAN  </span></h1>
                  <h2>Tempat Jual Beli Barang Bekas</h2>
                  <p>Tersedia berbagai macam kebutuhan sehari-hari, mulai dari elektronik sampai kendaraan bekas dengan harga yang bisa negosiasi dengan penjual langsung. </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/ruangan.png" class="ruangan img-responsive" alt="" />
                  <img src="images/home/pricing20.png"  class="pricing" alt="" />
                </div>
              </div>
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>CASHBACK 70%</span></h1>
                  <h2>Kategori Handphone </h2>
                  <p>Dapatkan handphone impian anda dengan pilihan harga termurah </p>
                  <p>s/k berlaku</p>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center">Menampilkan Item</h2>
       ...
       <?php  } ?>
          ...
          <div class="recommended_items"><!--recommended_items-->
            <h2 class="title text-center">barang-barang yang direkomendasikan</h2>
