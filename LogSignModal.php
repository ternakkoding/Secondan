                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; <a href="https://ternakkoding.blogspot.com/">Ternakkoding</a></p>
                        </div>
                    </div> 
                  </div>
                  <!-- end login panel -->
                      ...
                      <!-- <h4>Customer Details</h4>  --> 
                           ...
                           <form  class="form-horizontal span6" action="customer/controller.php?action=add" onsubmit="return personalInfo();" name="personal" method="POST" enctype="multipart/form-data">
                                <div class="panel panel-pup">
                                    ...
                                    Detail Pelanggan
                                     ...
                                     <div class="panel-body">
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          <label class="col-md-4 control-label" for=
                                          "PHONE">Nomor Kontak:</label>

                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder=
                                                "+62895600524735" type="number" value="">
                                          </div>
                                        </div>
                                      </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  Saya <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Setuju dengan <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>SYARAT DAN KETENTUAN</b></a> dari SECONDAN.</small>
                                    ...
                                    <div class="panel-footer">
                                        <p align="left">&copy; <a href="https://ternakkoding.blogspot.com/">Ternak Koding</a></p>
                                    </div> 
                            </div> 
                            <!-- end panel sign up -->
                        </form>  
