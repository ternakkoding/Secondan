...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i>0895600524735</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> secondan@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logo.jfif" alt="" /></a>
            </div> 
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>SECONDAN</span></h2>
              <p>Tempat jual beli barang bekas di seluruh indonesia </p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#"> 
                    <iframe class="iframe-img"  src="https://www.youtube.com/channel/UCBPQeiqjsYTxQVsTZUd--qQ"   allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
                </a> 
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#"> 
                   <iframe  class="iframe-img"  src="https://www.youtube.com/channel/UCBPQeiqjsYTxQVsTZUd--qQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
                </a> 
              </div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>Jl H Selong, Duri Kosambi, Jakarta Barat</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              ...
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="https://youtu.be/9hcCHTwW3HA">Sistem Pencatatan SDM</a></li>
                <li><a href="https://youtu.be/aMDC3Da4KIA">Titik Penjualan</a></li>
                <li><a href="https://youtu.be/d8N21Q_UN4w">Sistem Reservasi</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="single-widget">
              <h2>Tentang Secondan</h2>
              <ul class="nav nav-pills nav-stacked">
                <li><a href="#">informasi perusahaan</a></li>
                <li><a href="#">Karir</a></li>
                <li><a href="#">Lokasi Pusat</a></li>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="https://bit.ly/2LPn9Wu">Ternak Koding</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Sherlyyu12</a></span></p>
        </div>
      </div>
    </div>
