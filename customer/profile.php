    ...
    <div class="col-sm-3">
        <div class="panel">
            ...
            <!-- <li class="list-group-item text-muted">Profile</li> -->
                ...
                "pull-left"><strong>Nama Asli</strong></span>
                <?php echo $res->FNAME .' '.$res->LNAME; ?></li>
                <li class="list-group-item text-right"> 
                <div class="panel-group" id="accordion">   
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"  >Ubah Password</a>
        ...
        <div class="panel">
            <div class="panel-body">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li>
                        <a data-toggle="tab" href="#settings">Perbarui Akun</a>
                    </li>
                    <li>
            ...
            <div class="modal-content">
                ...
                "multipart/form-data" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        "btn btn-pup" name="savephoto" type="submit">Upload Foto</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
