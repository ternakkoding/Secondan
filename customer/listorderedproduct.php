...
?>
 	 <h4>Pesanan Mu Telah Di Terima dan Siap Di Kirim</h4><br/>
		<h5>Kepada pelanggan ,</h5>
		<h5>Karena Anda telah memesan uang tunai saat pengambilan, harap berikan jumlah uang tunai yang pas untuk dibayarkan kepada kurir dan bawalah detail penagihan ini.</h5>
		 <hr/>
		 ...
		 <div class="row">
		 	...
		 	<p>Alamat : <?php echo $cur->CUSHOMENUM . ' ' . $cur->STREETADD . ' ' .$cur->BRGYADD . ' ' . $cur->CITYADD . ' ' .$cur->PROVINCE . ' ' .$cur->COUNTRY; ?></p>
...
?>
 	 <h4>Pesanan Anda telah dikonfirmasi dan telah dikirim</h4><br/>
 		<h5>Kepada pembeli ,</h5>
		<h5>Pesanan Anda sedang dikirim! Karena Anda telah memesan melalui Cash on Delivery, harap berikan jumlah uang tunai yang tepat untuk pengirim kami.	</h5>
		 <hr/>
		 <h4><strong>Informasi Pengiriman</strong></h4>
		 <div class="row">
		 	<div class="col-md-6">
		 		<p> Kode pemesanan : <?php echo $_SESSION['ordernumber']; ?></p>
...
?>
<hr/>
 <h4><strong>Informasi Pemesanan</strong></h4>
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Harga : Rp <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Biaya Pengiriman : Rp <?php echo number_format($price,2); ?></p>
		  		<p align="right">Harga keseluruhan : Rp <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div>
		  ...
		  <div class="row">
		  	  ...
		  	  <p>SECONDAN</p>
		  	  <h4><a href="https://ternakkoding.blogspot.com/">SECONDAN INDONESIA</a></h4>
		  </div>
		  <?php }?>
  </div> 
