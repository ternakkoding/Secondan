...
?>
    ...
    <table>
      <tr>
        ...
        <h3 >Sarjana Teknik Informatika dan Pengusaha</h3> 
        </td>
      </tr>
    </table>
  ...
  <h5>Pesanan Anda sedang dalam proses. Silakan periksa profil Anda untuk pemberitahuan konfirmasi.</h5>
 ...
 <h4><strong>Informasi Pemesanan</strong></h4>
    ...
    <div class="row">
        ...
        <div class="col-md-6 pull-right">
          <p align="right">Total Harga : Rp <?php echo number_format($tot,2);?></p>
          <p align="right">Biaya Pengiriman : Rp <?php echo number_format($price,2); ?></p>
          <p align="right">Total Biaya : Rp <?php echo number_format($cur->PAYMENT,2); ?></p>
        </div>
      </div>
