      ...
      <div class="col-sm-3">
          ...
          <ul class="list-group">
            ...
            <!-- <li class="list-group-item text-muted">Profile</li> -->
             <li class="list-group-item text-right"><span class="pull-left"><strong>Nama Asli</strong></span> <?php echo $singlecustomer->FNAME .' '.$singlecustomer->LNAME; ?> </li>
            <li class="list-group-item text-right"><span class="pull-left"><strong>Bergabung</strong></span><?php echo date_format(date_create($singlecustomer->DATEJOIN),'M. d, y');?></li>
...
<div class="panel-header">
  <h2>Tracking Pesanan <SMALL><a href="<?php echo web_root; ?>index.php?q=profile" class="btn btn-sm btn-primary"><i class="fa  fa-chevron-left"></i> Back</a></SMALL></h2>
</div>          
  <div class="panel-body">
