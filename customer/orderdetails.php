...
<section id="cart_items">
    ...
    <input type="hidden" value="<?php echo $res->AUTO; ?>" id="ORDEREDNUM" name="ORDEREDNUM">
      Kode Pemesanan :<?php echo $res->AUTO; ?>
    </div>
    </div>
 </div>
      <div class="table-responsive cart_info"> 
              ...
              <table class="table table-condensed" id="table">
                ...
                <tr class="cart_menu"> 
                  ...
                  <th style="width:15%; align:center; ">Deskripsi</th>
                  <th style="width:15%; align:center; ">jUMLAH Stok</th>
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Harga :   Rp <span id="sum">0.00</span></div>
 ...
 <section id="do_action">
    <div class="container">
      <div class="heading">
        ...
        <p>Pilih apakah Anda memiliki kode promo atau poin reward yang ingin Anda gunakan atau ingin memperkirakan biaya pengiriman Anda.</p>
      </div>
      <div class="row">
         <div class="row">
                   <div class="col-md-7">
                                    ...
                                    <div class="form-group ">
                                      <label>Alamat tujuan pengiriman</label>
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          "PLACE">Tempat(Daerah/Kota):</label>
