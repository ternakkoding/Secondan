            ...
            <div class="panel panel-default">
              <div class="panel-body">
                <div class="text-center">
                  ...
                  <h2 class="text-center">Tidak ingat kata sandi?</h2>
                  <p>Letakkan kode Anda di sini.</p>
...
<div class="container">
	<div class="row">
		<div class="col-md-6 col-md-offset-4">
          	<h2 style="color: blue">Kata sandi telah diubah</h2>
          	 <a href="index.php">Kembali untuk masuk</a>
          </div>
	</div>
<?php  }else{ ?>
<div class="container">
