...
<span id="printout">
<div class="row" ><h3 align="center">Pendapatan Keseluruhan <?php echo ((@$_POST['start']) ? $_POST['start'] : '') . ' to ' .  ((@$_POST['end']) ? $_POST['end'] : '');?></h3></div>
<table  class="table table-bordered" cellspacing="0">
<thead>
<tr bgcolor="#bbd43b">
<td ><strong>Nama</strong></td>
<td ><strong>Nomor Pesanan</strong></td>
<td ><strong>Tenggal Pesanan</strong></td>
...
<tr> <h4 align="right"> Harga Keseluruhan : Rp <?php echo isset( $overall) ? $overall : 0; ?></h4>  </tr>
