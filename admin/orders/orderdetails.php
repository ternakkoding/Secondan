      ...
      <div class="">
        <div class="panel panel-default">
          <div class="panel-body">  
            <fieldset>  
              <legend><h2 class="text-left">Detail Pemesanan</h2></legend>

            <table class="fixnmix-table">
          
              <tbody>
                <tr>
                <td width="100px">Nama Depan </td><td  width="350px"> 
                ...
                <td width="100px">Nama Belakang </td><td> <input  id="LASTNAME" name="LASTNAME"  class="form-control input-sm"  type="text" value="<?php echo isset($_SESSION['LASTNAME'])? $_SESSION['LASTNAME'] : ""; ?>"></td>
                </tr>
                <tr>
                <td>Alamat </td><td> <input  id="ADDRESS" name="ADDRESS"  class="form-control input-sm"  type="text" value="<?php echo isset($_SESSION['ADDRESS'])? $_SESSION['ADDRESS'] : ""; ?>"></td>
                 <td  width="100px">Nomor Kontak  </td><td  width="350px"> <input  id="CONTACTNUMBER" name="CONTACTNUMBER"  class="form-control input-sm"  type="number" value="<?php  echo isset($_SESSION['CONTACTNUMBER'])? $_SESSION['CONTACTNUMBER'] : "";?>"></td>
              </tr>        
              </tbody> 
            ...
            <div class="container"> 
              <div class="row"> <h3  align="right" margin-right="20%">Total Harga : Rp <span  id="sum">0.00</span></h3></div>  
                </div>
