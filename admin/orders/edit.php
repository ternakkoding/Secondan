            ...
            <legend>Produk Baru</legend> 
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="ORIGIN" id="ORIGIN">
                          <option value="None">Pilih Asal</option>
                          <?php
             ...
             <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-8">
                        <button class="btn btn-btn_fixnmix" name="save" type="submit" >Simpan</button>
                      </div>
                    </div>
                  </div>
                  </div>
